                           ...
                           <td>
                               ...
                               <div class="normalDiv">
                                   <?php if($cart->itemcount>0) { ?>
                                    ...
                                    <table width="90%" border="0" align="center" cellpadding="2" cellpacing="1">
                                        <tr>
                                    ...
                                    <form action="cartreport.php" method="post" name="cartform" onSubmit="return checkForm();">
                                        <table width="90%" border="0" align="center" cellpadding="4" cellspacing="1">
                                            ...
                                            <tr>
                                                ...
                                                <td bgcolor="#F6F6F6">
                                                    <p>
                                                        <input type="text" name="cusomeremail" id="cusomeremail">
                                                        <font color="#FF0000">*</font>
                                                    </p>
                                                </td>
                                            </tr>
                                            ...
                                            <tr>
                                                ...
                                                <td bgcolor="#F6F6F6">
                                                    <p>
                                                        <input type="text" name="cusomeraddress" id="cusomeraddress" size="40">
                                                        <font color="#FF0000">*</font>
                                                    </p>
                                                </td>
                                            </tr>
